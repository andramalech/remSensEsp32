...
client_id = ubinascii.hexlify(machine.unique_id())  # cookie code use the board
# hardware id to diff the sensor
...
last_message = 0
message_interval = 5  # After dev change this to 60 second message interval
...
def read_sensor():
  try:
    # temp Section Nathan put the code here to read your sensor make
    # sure that you return the converted value as 'temp'
    # ////////////////////////////////////////////////////////////////////////
    temp = sensor.read()    # setup using the analog in pin with a pot
    # on pin 36 (A4) ADC Count
    ...
    # We need to set an alarm in ignition around 3.4v, 3.2v auto shutdown
    measuredvbat = bat.read()  # Read the value
    measuredvbat /= 4095  # divide by 4095 as we are using the
    # default ADC voltage range of 0-1V
...
# Still need to work on a deep sleep to preserve battery life.
# I'm thinking of dropping to  low power for 60 sec.
